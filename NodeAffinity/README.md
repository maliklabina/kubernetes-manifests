...
### During Scheduling (pod created for the first time)
- Required (If label not found pod will not schedule)
- preferred (If label not found , Ignore the rules and schedule pod on any available node)


### During Execution 
- Ignored (Pod will continue to run and any changes in node affinity will not impact them once they are scheduled)
